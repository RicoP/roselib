...
void g_rose_internal_register_utility_class_instance(int, rose::hash_value type_id, void * instance);
void * g_rose_internal_get_utility_class_instance(int, rose::hash_value type_id);
